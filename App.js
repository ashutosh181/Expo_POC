...
import { FormControl, InputLabel, MenuItem, Select, Table, TableBody,
TableCell, TableContainer, TableHead, TableRow, Paper, TextField } from
'@mui/material';
...
const mockData = [
   { id: 1, year: '2022', state: 'FL', variant: 'SMIRNOFF', comments:
'Great product' },
   { id: 2, year: '2021', state: 'GA', variant: 'RED VODKA', comments:
'Loved it' },
   { id: 3, year: '2023', state: 'MI', variant: 'CAPTAIN MORGAN',
comments: 'Not bad' },
   { id: 4, year: '2020', state: 'MA', variant: 'JOHNNIE WALKER',
comments: 'Fantastic' },
   { id: 5, year: '2019', state: 'NM', variant: 'DON JULIO', comments:
'Smooth' },
];
         ...
         <LeftPane>
           <PowerBIEmbed
             embedConfig={{
               ...
               embedUrl:
"https://app.powerbi.com/reportEmbed?reportId=6f14e67d-a0e0-4ab2-b5fc-44b2f4085cf6&groupId=46f473fc-dc97-42ea-8c93-ab44d4dd9f4d&w=2&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly9XQUJJLVVTLU5PUlRILUNFTlRSQUwtQi1yZWRpcmVjdC5hbmFseXNpcy53aW5kb3dzLm5ldCIsImVtYmVkRmVhdHVyZXMiOnsibW9kZXJuRW1iZWQiOnRydWV9fQ%3d%3d",
             ...
             eventHandlers={new Map([
               ...
               ['rendered', function () { console.log('Reportrendered'); }],
               ['error', function (event) { console.log(event.detail); }],
               ['visualClicked', () => console.log('visual clicked')],
               ['pageChanged', (event) => console.log(event)],
             ])}
             cssClassName="container"
             getEmbeddedComponent={(embeddedReport) => { window.report =
embeddedReport; }}
           />
         </LeftPane>
         <RightPane>
...
label="State">
             ...
             <LocalizationProvider dateAdapter={AdapterDayjs}>
               <DemoContainer sx={{ minWidth: "10%", marginTop: '-7px',
marginRight: '17px', borderRadius: '4px' }} components={['DatePicker']}>
...
onChange={handleVariantChange} label="Variants">
                 <MenuItem value=""><em>None</em></MenuItem>
           ...
           <TableContainer style={{border:"2px solid grey",width:"97%"}}
component={Paper}>
             <Table sx={{ '& .MuiTableCell-root': { border: '1px solidgrey' } }}>
               <TableHead>
...
<TableCell>{row.variant}</TableCell>
                     <TableCell>
                       <TextField
                         value={row.comments}
                         onChange={(e) => handleCommentChange(row.id,
e.target.value)}
                         fullWidth
                       />
                     </TableCell>
